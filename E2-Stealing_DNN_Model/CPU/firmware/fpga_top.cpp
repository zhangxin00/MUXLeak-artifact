...
// ==============
// =  FPGA TOP  =
// Reading info for each laye, including DRAM address, layer info, weights offset, weights num, input offeset
// ==============
...
#pragma HLS LOOP_TRIPCOUNT min = 8 max = 256 avg = 45
    ...
    p_pixelSetup : {
      ...
      // Stride-2 Skipping
      // Skipp pixels which do need CONV
...
#pragma HLS pipeline II = 1
        ...
        // Postprocess
        // ADD biass and RELU Actication FUNCTION
